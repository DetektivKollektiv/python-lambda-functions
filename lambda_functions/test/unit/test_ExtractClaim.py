...
class TestExtractClaim:
    def test_extract_claim_1(self):
        ...
        assert resp["urls"][1] == "https://www.spiegel.de/wissenschaft/mensch/corona-krise-und-klimawandel-fuenf" \
                                  "-desinformations-tricks-die-jeder-kennen-sollte-a-6892ff9b-fb28-43ae-8438-55b49d607e57" \
                                  "?sara_ecid=soci_upd_wbMbjhOSvViISjc8RPU89NcCvtlFcJ"
        assert resp["titles"][
                   1] == "Corona-Krise und Klimawandel: Fünf Desinformations-Tricks, die jeder kennen sollte - " \
                         "DER SPIEGEL"
