...
from core_layer.model import Item, User, Review, ReviewQuestion, Level
...
def test_item_model_to_dict_with_reviews(item_id, review_id, review_answer_id, user_id):
    with Session() as session:
        ...
        item_dict = item.to_dict(with_reviews=True)
