...
class TestExtractClaim:
    def test_extract_claim_1(self):
        ...
        context = ""
        title, paragraphs = ExtractClaim.extract_claim(event, context)
        assert title == "Corona-Krise und Klimawandel: Fünf Desinformations-Tricks, die jeder kennen sollte - DER " \
                        "SPIEGEL"
        assert paragraphs == "US-Präsident Donald Trump, Fachmann für Falschinformation Haben Sie auch solche " \
